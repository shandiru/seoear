  ...
  return (
    <section className="py-20 bg-[linear-gradient(to_bottom_right,#F8FAFC,white,#EAF7F3)]">
      <div className="container mx-auto px-4">
        ...
        Book your ear wax removal in Lichfield today, serving homes across Lichfield and throughout Lichfield.
          </p>
          <p className="text-lg md:text-xl text-[#4B5563] mb-10 leading-relaxed">
Earwego, trusted by residents across Lichfield for professional mobile ear wax removal.
          </p>
