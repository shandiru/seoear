      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-[#334155] max-w-3xl mx-auto">
            There’s no messy ear syringing in Lichfield — just expert, friendly
        ...
        <div className="bg-[linear-gradient(to_right,#43AA8B,#9C79B3)] rounded-2xl p-10 text-center text-white shadow-lg">
          ...
          <p className="text-lg leading-relaxed max-w-3xl mx-auto">
            There’s no need for ear syringing in Lichfield clinics, just reliable care from professionals who come to you.
          </p>
        </div>
      </div>
    </section>
