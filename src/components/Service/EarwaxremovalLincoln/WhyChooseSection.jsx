  ...
  const benefits = [
    {
      ...
      title: "Convenience",
      description:
        "Home visits across Lincoln and nearby areas — professional ear care delivered right to your door.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Trained, well-equipped clinicians using medical-grade tools to ensure reliable, high-quality results.",
    },
    {
      icon: (
        <svg
      ...
      title: "Comfort",
      description:
        "We provide calm, clear communication and gentle treatment throughout every appointment.",
    },
    {
      icon: (
        <svg
      ...
      title: "Safety",
      description:
        "Gentle, hygienic methods trusted by clients across Lincolnshire for safe, effective ear wax removal.",
    },
  ];
    ...
    <section className="py-16 md:py-24 bg-[linear-gradient(to_bottom,#F8FAFC,white,#EAF7F3)]">
      <div className="container mx-auto px-4 max-w-4xl text-center">
        ...
        <p className="text-lg md:text-xl text-[#334155] max-w-3xl mx-auto mb-10">
          Professional ear wax removal made simple — safe, comfortable, and brought to you by experienced specialists.
        </p>
