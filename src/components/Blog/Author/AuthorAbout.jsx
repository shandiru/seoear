...
const AuthorAbout = () => {
  return (
    <div className="px-16 py-12 bg-white rounded-xl flex flex-col md:flex-row items-center md:items-start gap-12">
      
      {/* Left Content - Full Details Added Here */}
      <div className="flex-1 w-full md:w-1/2 space-y-6">
        <div>
        ...
        <p className="text-gray-700">
          ...
          <span className="text-[#43AA8B]">Ear Wax Removal</span>,{" "}
          <span className="text-[#43AA8B]">Home Care</span>,{" "}
          <span className="text-[#43AA8B]">Patient Education</span>
        </p>
      </div>
