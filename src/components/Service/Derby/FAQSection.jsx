...
export default function FAQSection() {
  ...
  const faqs = [
    {
      question: "Do you cover all areas of Derby?",
      answer:
        "Yes, including Allestree, Littleover, Mickleover and nearby villages such as Duffield and Quarndon.",
    },
    {
      question: "How soon can I book?",
      answer:
        "We usually have same-week or next-day availability in Derbyshire.",
    },
    {
      question: "Is microsuction better than ear syringing?",
      answer:
        "Yes, it’s cleaner, safer and avoids water-related risks.",
    },
    {
      question: "Can you help if I use hearing aids?",
      answer:
        "Yes, regular wax removal can improve hearing aid performance.",
    },
    {
      question: "How long does treatment take?",
      answer:
        "Usually about 30 minutes from start to finish.",
    },
  ];
