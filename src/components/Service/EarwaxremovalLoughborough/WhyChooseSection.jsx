  ...
  const benefits = [
    {
      ...
      title: "Convenience",
      description:
        "Home visits throughout Loughborough and nearby villages.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Trained clinicians with medical-grade tools.",
    },
    {
      icon: (
        <svg
      ...
      title: "Comfort",
      description:
        "Clear communication and calm service",
    },
    {
      icon: (
        <svg
      ...
      title: "Safety",
      description:
        "Proven microsuction method trusted across Leicestershire.",
    },
  ];
    ...
    <section className="py-16 md:py-24 bg-[linear-gradient(to_bottom,#F8FAFC,white,#EAF7F3)]">
      <div className="container mx-auto px-4 max-w-4xl text-center">
        ...
        <p className="text-lg md:text-xl text-[#334155] max-w-3xl mx-auto mb-10">
          Professional ear care in Loughborough — convenient, comfortable, and safe home visits by skilled clinicians.
        </p>
