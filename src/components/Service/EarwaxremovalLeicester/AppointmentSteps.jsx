  ...
  const steps = [
    {
      ...
      desc: "Easily schedule your appointment online or over the phone at a time that suits you.",
      icon: (
        <svg
    ...
    },
    {
      ...
      desc: "Your clinician visits at a convenient time, bringing safe and professional equipment.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    {
      id: 3,
      title: "Your clinician examines your ears and explains the process",
      desc: "A short ear examination ensures everything is ready, and the clinician explains each step clearly.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    {
      id: 4,
      title: "Microsuction removes the wax safely",
      desc: "Gentle microsuction removes ear wax quickly and safely — clean, precise, and water-free.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    {
      id: 5,
      title: "Aftercare advice helps prevent future build-up",
      desc: "You’ll receive professional aftercare advice to keep your ears clear and prevent wax returning.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 p-8 rounded-2xl bg-[#43AA8B]/10 border border-[#43AA8B]/30 text-center">
          <p className="text-lg text-[#0D1525] leading-relaxed">
            ...
            <span className="font-semibold text-[#43AA8B]">immediate results</span>.
          </p>
        </div>
      </div>
    </section>
