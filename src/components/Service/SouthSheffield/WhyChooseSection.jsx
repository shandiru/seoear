  ...
  const benefits = [
    {
      ...
      title: "Convenience",
      description:
        "Mobile ear wax removal across South Sheffield and nearby villages — no need to travel to a clinic.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Our trained clinicians use safe, medical-grade equipment and maintain the highest standards of care.",
    },
    {
      icon: (
        <svg
      ...
      title: "Comfort",
      description:
        "We explain every step clearly and perform each treatment gently for a calm, comfortable experience.",
    },
    {
      icon: (
        <svg
      ...
      title: "Safety",
      description:
        "Using trusted microsuction techniques recognised across South Yorkshire for safe ear wax removal.",
    },
  ];
    ...
    <section className="py-16 md:py-24 bg-[linear-gradient(to_bottom,#F8FAFC,white,#EAF7F3)]">
      <div className="container mx-auto px-4 max-w-4xl text-center">
        ...
        <p className="text-lg md:text-xl text-[#334155] max-w-3xl mx-auto mb-10">
          Your trusted mobile ear care specialists across South Sheffield and
          South Yorkshire — offering safe, professional, and gentle ear wax
