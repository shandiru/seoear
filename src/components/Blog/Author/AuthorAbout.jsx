...
const AuthorAbout = () => {
  return (
    <div className="px-16  py-12 bg-white dark:bg-gray-900 rounded-xl shadow-lg flex flex-col md:flex-row items-center md:items-start gap-8">
      ...
      <div className="flex-1 w-full md:w-1/2 space-y-4">
        ...
        <p className="text-gray-700 dark:text-gray-300">
          ...
          <a href="#" className="text-blue-600 hover:underline">Blinds</a>,{" "}
          <a href="#" className="text-blue-600 hover:underline">Shutters</a>,{" "}
          <a href="#" className="text-blue-600 hover:underline">Curtains</a>, Outdoor Products, Sustainability
        </p>
        ...
        <p className="text-gray-700 dark:text-gray-300">
          ...
          <a href="#" className="text-blue-600 hover:underline">Yvonne Keal | LinkedIn</a>
        </p>
      </div>
