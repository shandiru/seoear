  ...
  const steps = [
    {
      ...
      desc: "Easily schedule your appointment online or by phone at a time that suits you.",
      icon: (
        <svg
    ...
    },
    {
      ...
      desc: "Our friendly clinician arrives at your home with all required medical equipment.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    },
    {
      ...
      desc: "We inspect your ear canals and explain the process before treatment begins.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    },
    {
      ...
      desc: "Gentle medical suction safely removes earwax — no water, no mess, no discomfort.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    },
    {
      ...
      desc: "We provide easy aftercare tips to help you maintain clear, healthy ears long-term.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
