  ...
  const steps = [
    {
      ...
      desc: "Book your appointment easily online or over the phone at a time that suits you.",
      icon: (
        <svg
    ...
    },
    {
      ...
      desc: "Your clinician arrives at your home at a convenient time with sterilised equipment.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    },
    {
      ...
      desc: "Your clinician examines your ears and clearly explains the microsuction process.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    {
      id: 4,
      title: "Microsuction Procedure",
      desc: "Microsuction gently removes the earwax — it’s quick, precise, and completely water-free.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    {
      id: 5,
      title: "Aftercare & Healthy Ears",
      desc: "You’ll receive helpful aftercare advice to keep your ears clean and healthy.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-[#334155]">
            From booking to aftercare, here’s what you can expect during your home visit:
          </p>
        </div>
