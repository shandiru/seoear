  ...
  const steps = [
    {
      ...
      desc: "Schedule your appointment easily online or by phone at a time that suits you.",
      icon: (
        <svg
    ...
    },
    {
      ...
      desc: "Our clinician arrives promptly with sterilised medical-grade equipment.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    },
    {
      ...
      desc: "We assess your ear canals and explain the procedure before beginning treatment.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    },
    {
      ...
      desc: "Microsuction gently clears earwax using precision suction — quick, safe, and dry.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    },
    {
      ...
      desc: "We provide simple aftercare guidance to help keep your ears clear and comfortable.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
