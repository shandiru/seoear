  ...
  const benefits = [
    {
      ...
      title: "Convenience",
      description:
        "Mobile service across Worksop and surrounding villages",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Clinicians trained to deliver medical-standard ear care.",
    },
    {
      icon: (
        <svg
    ...
    },
    {
      ...
      title: "Safety",
      description:
        "Proven microsuction technique trusted by clients across Nottinghamshire.",
    },
  ];
    ...
    <section className="py-16 md:py-24 bg-[linear-gradient(to_bottom,#F8FAFC,white,#EAF7F3)]">
      <div className="container mx-auto px-4 max-w-4xl text-center">
        ...
        <p className="text-lg md:text-xl text-[#334155] max-w-3xl mx-auto mb-10">
          Professional ear care in Worksop — convenient, comfortable, and safe home visits by skilled clinicians.
        </p>
