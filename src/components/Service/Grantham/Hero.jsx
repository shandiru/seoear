...
export default function EarWaxHero() {
  ...
  If blocked ears are affecting your hearing, our professional ear wax removal service in{" "}
  <strong className="text-[#43AA8B]">Grantham</strong> provides safe and effective treatment
  without needing to visit a clinic. At{" "}
  <strong className="text-[#43AA8B]">EarWeGo</strong>, we bring expert ear care directly to
  your home, using gentle microsuction for clear, comfortable results.
  <br />
  <br />
  Our clinicians cover all parts of Grantham and surrounding areas including Barrowby,
  Gonerby Hill Foot, Great Gonerby and nearby villages such as Harlaxton and Belton.
</p>
