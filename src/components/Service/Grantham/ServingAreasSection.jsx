      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#0D1525] font-serif">
            Serving Grantham &amp; Surrounding Areas
          </h2>
          <p className="text-lg text-[#334155] leading-relaxed">
            We’ve helped residents across{" "}
            <strong>
              Barrowby Gate, Gonerby Hill Foot, Manthorpe, Alma Park, Earlesfield,
              Harrowby, Somerby Hill, Great Gonerby, Swingbridge, St. Anne’s, Green Hill
            </strong>{" "}
            and <strong>Grantham Town Centre</strong> experience clearer hearing — often
            in just one visit.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-sm text-[#4B5563] max-w-2xl mx-auto leading-relaxed">
            We cover all of Grantham and nearby villages across Lincolnshire. Contact us
