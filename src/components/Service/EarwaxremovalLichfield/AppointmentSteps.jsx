...
export default function AppointmentSteps() {
  const steps = [
    ...
    },
    {
      ...
      desc: "Your clinician arrives at your home with safe, sterilised equipment ready for treatment.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    },
    {
      ...
      desc: "A short assessment ensures your ears are ready, and the clinician explains each step clearly.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    },
    {
      ...
      desc: "Gentle medical suction removes ear wax quickly and safely — no water or mess involved.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
    ...
    },
    {
      ...
      desc: "We provide simple aftercare tips to help you maintain clear, healthy ears after treatment.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
