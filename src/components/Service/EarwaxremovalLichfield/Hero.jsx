...
export default function EarWaxHero() {
  ...
  If you’re in <strong className="text-[#43AA8B]">Lichfield</strong> and struggling with blocked ears, our professional ear
  ...
  ear care delivered by trained clinicians right across Lichfield and the wider
  Lichfield area.
