      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-[#334155] leading-relaxed">
            ...
            <strong>
              Brampton, Hasland, Newbold, Walton, Boythorpe, Spital, Tapton,
              Whittington Moor, Hunloke Park, Holymoorside, Wingerworth
            </strong>{" "}
            and{" "}
            <strong>Chesterfield Town Centre</strong> hear clearly again — often
            in just one visit.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-sm text-[#4B5563] max-w-2xl mx-auto leading-relaxed">
            We cover Chesterfield and nearby towns across Derbyshire. Contact us
            to confirm if our convenient at-home ear wax removal service is
